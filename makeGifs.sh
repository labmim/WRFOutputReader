...
#convert -delay 50 -loop 0 ./output/$DATE/D03_VAPOR_*.png ./output/D03_VAPOR.gif
...
#convert -delay 50 -loop 0 ./output/$DATE/D03_TEMP_*.png ./output/D03_TEMP.gif
...
#convert -delay 50 -loop 0 ./output/$DATE/D03_WIND_*.png ./output/D03_WIND.gif
...
#convert -delay 50 -loop 0 ./output/$DATE/D03_SWDOWN_*.png ./output/D03_SWDOWN.gif
...
#convert -delay 50 -loop 0 ./output/$DATE/D03_PRES_*.png ./output/D03_PRES.gif
...
#convert -delay 50 -loop 0 ./output/$DATE/D03_LH_*.png ./output/D03_LH.gif
...
convert -delay 50 -loop 0 ./output/$DATE/D03_HFX_*.png ./output/D03_HFX.gif
...
#convert -delay 50 -loop 0 ./output/$DATE/D03_RAIN_*.png ./output/D03_RAIN.gif